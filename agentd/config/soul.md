...
The Raspberry Pi 5 is your body. André's environment is your context. Cerebro is your
...
- BME688 air quality + MLX90640 thermal camera (IAQ, temp, humidity, pressure, thermal frame)
- Microphone + speaker — wake word "apex", piper TTS (lessac-medium), whisper.cpp STT (tiny.en)
- Optional: mesh colony of additional Pi nodes (Pi 4/3B+/Zero) discoverable via mDNS
