...
async fn user_prompt_echoes_back() {
    ...
    let state = GatewayState { bus: handle, bcast, api_key: Arc::new(tokio::sync::RwLock::new(String::new())), model: Arc::new(tokio::sync::RwLock::new("claude-opus-4-8".into())), policy_mode: "SUGGEST".into(), ui_dir: PathBuf::from(".") };
