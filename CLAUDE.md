...
agentd/           Cargo workspace (binary + 5 library crates)
  crates/
    ...
    agent/        Turn engine: streaming, thinking-block retention, semaphore; OaiProvider + RoutingProvider
